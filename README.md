...
注意：初期ローディングに少し時間がかかります。　　
Favdule help page : https://favdule.onrender.com/help
### 利用の流れ　　
【チャンネルをグループに登録】  
1．右上の≣からSearchをクリック  
2．検索バーから好きなYoutuberのチャンネル名を入力  
3．出てきたチャンネルの中から追加するチャンネルをクリック  
4．追加するグループを選択し追加ボタンをクリック  

【グループの配信情報閲覧】  
上記の”チャンネルをグループに登録”を終えるとホームから登録済みのチャンネルの昨日・今日・明日の配信をチェックできます。
